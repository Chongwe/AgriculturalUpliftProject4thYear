...
import { CardHeader, Section, Card, CardBody, H5, LeadText, Icon, IconButton } from '@material-tailwind/react';
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg ">
          <div className="sm:p-6 w-full border-0 bg-white shadow-md rounded-md p-4 border-t border-b ">
             <div className="flex items-center space-x-2">
              ...
              <span className="text-lg leading-6 font-medium text-gray-900">Jimmy Maloya {}</span>
         </div>
