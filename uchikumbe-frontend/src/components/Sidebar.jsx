...
/**
 * The code defines a React functional component called `Carousel`. It uses React hooks, such as
...
const Carousel = () => {
  ...
  /**
   * The `useEffect` hook is used to fetch carousel data from Sanity when the component mounts.
   *
   * @function useEffect
   * @inner
   * @param {array} dependencies An array of values that the effect depends on. If any of the
   * dependencies change, the effect will run again.
   * @returns {void}
   */
  useEffect(() => {
  ...
  const { title, description, image } =
    carouselData[
      currentIndex
    ]; /**  Destructure the data for the current index */
