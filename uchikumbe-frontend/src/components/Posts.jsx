...
const Posts = ({
  ...
  return (
    <div className=" max-w-[600px] m-12 transition-all pt-4 overflow-wrap break-word  duration-500 hover:scale-105 p-4 bg-white rounded-xl  flex-wrap min-w-[400px] ">
