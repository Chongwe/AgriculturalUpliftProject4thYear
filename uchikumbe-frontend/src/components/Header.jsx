...
export default function Fun({ user = null }) {
  ...
  return (
    <Navbar
    className="lg:w-full w-full sm:rounded-lg rounded-none mx-auto sticky min-w-screen-sm duration-75 p-0 top-0 z-50 max-w-screen-xl bg-opacity-70 backdrop-filter backdrop-blur-md pt-2 bg-green-900 text-white px-8 lg:px-8 lg:py-0">
